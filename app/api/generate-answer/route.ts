...
const client = edgedb.createHttpClient({ tlsSecurity: "insecure" });
...
async function moderateQuery(query: string, secretKey: string) {
...
async function getEmbedding(query: string, secretKey: string) {
